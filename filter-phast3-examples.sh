#!/bin/bash -ex
git clone --bare git@code.chs.usgs.gov:coupled/save/phast3-examples.git
git clone phast3-examples.git

cd phast3-examples.git
...
cat > ../phast3_examples_strip_blob_ids<<EOF
...
# ab297fc2c52a00bb8aa2e623dbc52043a38c53c8 -> capecod/WalterData/head_all_pts
# 29aaf8f514a094897680f2b6ed3aeef6e541e0e5 -> capecod/WalterData/kh_points
# 459567053c198fefb3315702f4f4451f8bd090f4 -> capecod/WalterData/kz_points
# 9e4d0188cf3b8669a9b997dcf5f07a8cfcfb8f92 -> [capecod/ex5/Parameters/iniital_C.dat, ex5/Parameters/iniital_C.dat]

cd ../phast3-examples.git
git filter-repo --force \
  --strip-blobs-with-ids ../phast3_examples_strip_blob_ids \
  --blob-callback '
...
# verify
cd ..
git clone --bare phast3-examples.git/ phast3-examples-filtered.git
cd phast3-examples-filtered.git
git filter-repo --analyze
